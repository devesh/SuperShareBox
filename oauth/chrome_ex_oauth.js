 ...
 * @param {Boolean} reauthorize Whether to force reauthorization and get a new token
 */
ChromeExOAuth.prototype.authorize = function(callback, reauthorize) {
  if (this.hasToken() && !reauthorize) {
...
ChromeExOAuth.prototype.sendSignedRequest = function(url, callback,
  ...
  headers['Authorization'] = this.getAuthorizationHeader(url, method, params, body);
